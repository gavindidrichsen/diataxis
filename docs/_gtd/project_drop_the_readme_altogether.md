...
- [[@INBOX/docs/tools/puppet/repositories/gavindidrichsen/diataxis/docs/adr/0003-auto-generate-readme-with-document-links|ADR-0003]] — superseded; originally established README auto-generation.
- [[@INBOX/docs/tools/puppet/repositories/gavindidrichsen/diataxis/docs/adr/0006-implement-automated-readme-link-management|ADR-0006]] — superseded; the relative-Markdown link format being replaced.
