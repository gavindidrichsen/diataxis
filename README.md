...
<!-- projectlog -->
* [Drop the README altogether](docs/_gtd/project_drop_the_readme_altogether.md)
* [Simplify Diataxis CLI Output Routing Behaviour](docs/_gtd/project_simplify_diataxis_cli_output_routing_behaviour.md)
<!-- projectlogstop -->
